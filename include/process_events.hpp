...
public:
    ...
    bool add_file(const std::vector<std::string> &) const;
    bool add_folder(const std::vector<std::string> &) const;
    bool rename_DecRep_file(const std::vector<std::string> &) const;
    bool rename_DecRep_folder(const std::vector<std::string> &) const;
    bool change_DecRep_path(const std::vector<std::string> &) const;
    bool add_user(const std::vector<std::string> &) const;
    bool update_file(const std::vector<std::string> &) const;
    bool update_local_file_path(const std::vector<std::string> &) const;
    bool update_local_folder_path(const std::vector<std::string> &) const;
    bool untrack_file(const std::vector<std::string> &) const;
